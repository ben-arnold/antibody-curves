...
#-------------------------------
# Fig4-2-garki-wet-dry-analysis-figure.R
#
...
text(1,3.3,"1971 wet",cex=1.25,adj=0,font=1,col=cols[1])
text(3.5,2.9,"1972 dry season",cex=1.25,adj=0,font=1,col=cols[2])
...
text(1.7,3.3,"1972 wet",cex=1.25,adj=1,font=1,col=cols[3])
text(4.5,2.9,"1973 dry season",cex=1.25,adj=0,font=1,col=cols[4])
text(8.5,3.7,"1973 wet",cex=1.25,adj=0,font=1,col=cols[5])
...
# age group labels
mtext(c("<5 years","5 to 10 years"),side=1,line=1,at=1:2,cex=1)
...
plabel.y <- 3.8
text(mean(xs.0to4[1:2]),y=plabel.y,labels=pformat[1,1],pos=3,cex=1,col="gray40")
...
text(mean(xs.0to4[3:4])-0.02,y=plabel.y,labels=pformat[3,1],pos=3,cex=1,col="gray40")
...
text(mean(xs.0to4[4:5])+0.02,y=plabel.y,labels=pformat[4,1],pos=3,cex=1,col="gray40")
...
text(mean(xs.5to9[4:5]),y=plabel.y,labels=pformat[4,2],pos=3,cex=1,col="gray40")
