...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.75\textwidth]{/users/benarnold/SLAbcurves/results/figs/mauke-Wb123-analysis-2y-beeswarm.pdf}
...
\begin{figure}[htbp]
\begin{center}
%\includegraphics[width=0.5\textwidth]{/users/benarnold/Dropbox/caira/results/figs/CaIra-Wb123-Bm14-Bm33-antibody-curves-SL.pdf}
\begin{minipage}{0.75\textwidth}
\caption{Placeholder for Ca Ira Haiti results }
\label{fig:cairaS2}
\end{minipage}
\end{center}
\end{figure}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=\textwidth]{/users/benarnold/Dropbox/garki/figs/garki-IFATpf-by-village-svy.pdf}
\begin{minipage}{\textwidth}
