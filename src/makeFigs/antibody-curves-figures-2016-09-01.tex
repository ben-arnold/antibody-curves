...
\vspace{-10pt}
\begin{center}
\includegraphics[width=0.33\textwidth]{/users/benarnold/dropbox/articles/antibody-curves/results/figs/garki-cvR2-age-control.pdf}
...
\vspace{-10pt}
\begin{center}
\includegraphics[width=0.33\textwidth]{/users/benarnold/dropbox/articles/antibody-curves/results/figs/garki-cvSLcurves-control.pdf}
